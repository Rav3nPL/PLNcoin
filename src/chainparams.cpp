...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000000281e2c943691aa");//done

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x1a10d5988b25ecc40bcf94e976d18dc80230d7200e5be29ae65a81f67fef0c15"); //881352
        ...
        checkpointData = (CCheckpointData) {//done
            boost::assign::map_list_of
            (     0, uint256S("0x58c63157cc65022e582ebf3b192fa43b9ba8558eeb26954706d8d3c6924853e5"))
            (881268, uint256S("0x4d9efac3b6ce3d767b8e3ba3f2a260f8478346ee7ec82342ff46ec760d7b89cd"))
        };

        chainTxData = ChainTxData{ //done
            // Data as of block  1a10d5988b25ecc40bcf94e976d18dc80230d7200e5be29ae65a81f67fef0c15 (height 881352).
            1503767964, // * UNIX timestamp of last known number of transactions
            1125081,  // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        consensus.BIP66Height = 10; // 8075c771ed8b495ffd943980a95f702ab34fce3c8c54e379548bda33cc8c0573
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        genesis = CreateGenesisBlock(1300000000, 765943, 0x1e0ffff0, 1, 44 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x54790e8cdee8c1c9d2e9aeeab70b5e8fb0efc88b8dd96ba194634eb8f49ba91f"));
        assert(genesis.hashMerkleRoot == uint256S("0xf6513239070801245a6707a88beea6dfaf818cf6e48c4375c3b9ef2f31f2235f"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("plncoin.com", "testnet-seed.plncoin.com"));
        vSeeds.push_back(CDNSSeedData("seed.plncoin.com", "seed.plncoin.com", true));
        vSeeds.push_back(CDNSSeedData("rav3n.dtdns.net", "rav3n.dtdns.net", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x54790e8cdee8c1c9d2e9aeeab70b5e8fb0efc88b8dd96ba194634eb8f49ba91f")),
        };
